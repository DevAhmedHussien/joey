    ...
    <>
      ...
      <div maxWidth="lg" style={{ background :colors.primary[100]}}>
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={6}>
              <motion.div 
                  ...
                  animate="visible"
                >
                <Card height={400} title={'Weight Loss'} src={imgWeightloss} alt={'Weight Loss'} widthImg={400} heighImg={400} size={true} href={'/'}/>
              </motion.div>
            </Grid>
            <Grid item xs={12} md={6}>
            <motion.div 
                  ...
                  animate="visible"
                >
                <Card height={400} title={'Sexual Health'} src={imgSexual} alt={'Sexual Health'} widthImg={200} heighImg={200} size={true} href={'/'}/>
              </motion.div>
            </Grid>
            ...
            <motion.div 
                  ...
                  animate="visible"
                >
                  <Card height={200} //title={'Best Seller From Our Pharmacy'}
        ...
        <Box className="greeting">
          <VideoRolling title='JoeyMed Telehealth' description='Keep it off with Joey' src="/videos/weightVideo.mp4"/>
