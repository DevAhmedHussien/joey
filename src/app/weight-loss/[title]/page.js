...
export default function ProductsPage(props) {
  ...
  return (
    <>
      <Head>
        <title>{specificProduct[0]?.itemName} - weight loss Product | Joey Med</title>
        <meta name="description" content={`${specificProduct[0]?.description} Find out more about ${specificProduct[0]?.itemName} and how it can benefit your weight loss.`} />
        <link rel="canonical" href={`https://www.joeymed.com/weight-loss/${props.params.title}`} />
        ...
        <meta property="og:image" content={specificProduct[0]?.images[0] } />
